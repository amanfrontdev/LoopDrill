        ...
        <div className="flex  gap-x-3 flex-col md:flex-row justify-center max-w-[1920px] m-auto px-10 py-10">
          ...
          {cardsData.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className={`relative rounded-b-3xl overflow-hidden text-2xl tracking-normal p-2 font-semibold w-full ${isExpanded
                  ? "w-[100%] min-h-40 text-customPurple"
                  : " text-white w-full md:w-[15%] min-h-16 justify-center items-center flex "
              ...
              >
                ...
                <div
                  className={`absolute break-words ${isExpanded ? "top-4 left-4" : "bottom-32 left-4"
                ...
                <div
                  className={`absolute whitespace-nowrap  transform transition-transform duration-1000 ${isExpanded ? "rotate-0" : " md:-rotate-90"
                    }`}
